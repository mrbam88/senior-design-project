...
import ingenias.exception.NotFound;
  ...
  public class CoordRoleCoordCitInteractionDefaultCommControl extends DefaultCommControl{
  
  	  private Vector<String> previous=new Vector<String>();
  	  
  public CoordRoleCoordCitInteractionDefaultCommControl(String cid, MentalStateReader msr, ingenias.jade.comm.LocksRemover lr){
  super(msr, lr);
  };
...
public boolean continueProcess(Vector<ACLMessage> multipleMessages,String[] options,
  ...
  // String sequence= sb.getState();
    ...
    if (sb.isState("waiting for InformReportFF")&& options.length>0 && mes!=null
    && mes.getUserDefinedParameter("sequence")!=null &&
    		mes.getUserDefinedParameter("sequence").equals("InformReportFF")){
    	 boolean allexist=true;
         
         if (allexist && true){
     	   sb.removeState("waiting for InformReportFF");           
    	   try {
