...
*/
			...
			public class CitizenAgentInteractionLocks implements CustomLocks {
			
			public CitizenAgentInteractionLocks(){};
			
			        public void addInteractionLocks(String interaction, LocksWriter lw){
                                    
                   if (interaction.equals("SendInfect") ){
                            CitRoleSendInfectDefaultCommControl.addDefaultLocks(lw);
                   }
                  
		           // Interactions in which this agent appears as initiator                  
                  
                  if (interaction.equals("CoordCitInteraction")){
                    CitRoleCoordCitInteractionDefaultCommControl.addDefaultLocks(lw);
                  }
