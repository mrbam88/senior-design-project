...
public class SendSickLocFF extends ingenias.editor.entities.RuntimeFact{
  ...
  public SendSickLocFF (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="SendSickLocFF";
  }
  

  public SendSickLocFF (){
